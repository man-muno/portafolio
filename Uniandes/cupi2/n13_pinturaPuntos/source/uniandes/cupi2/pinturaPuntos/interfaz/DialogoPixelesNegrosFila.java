/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: DialogoPixelesNegrosFila.java,v 1.1 2007/03/05 02:09:02 man-muno Exp $
...
public class DialogoPixelesNegrosFila extends JDialog
{
     ...
     */
    public DialogoPixelesNegrosFila( InterfazPinturaPuntos principal )
    {
        super( principal );
     ...
     * Arma el botón aceptar
     * 
     * @return Devuelve el botón aceptar para el tipo de función 1.
     */
    private JButton getBtnAceptar1( )
    {
        if( btnAceptar == null )
        {
     ...
     * Arma el botón aceptar
     * 
     * @return Devuelve el botón aceptar para el tipo de función 2.
     */
    private JButton getBtnAceptar2( )
    {
        if( btnAceptar == null )
        {
