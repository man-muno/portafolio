/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: DialogoPixelesNegrosColumna.java,v 1.2 2007/04/24 00:42:49 man-muno Exp $
...
public class DialogoPixelesNegrosColumna extends JDialog
{
     ...
     */
    public DialogoPixelesNegrosColumna( InterfazImagenDispersaPuntos principal )
    {
        super( principal );
    ...
    /**
     * Muestra en un diálogo el número de píxeles negros de una columna.
     * 
     */
    private void mostrarColor( )
    {
        ...
        {
            String mensaje = "Número de píxeles negros en la columna " + y + " es: " + principal.darNumeroPixelesNegrosColumna( y );
