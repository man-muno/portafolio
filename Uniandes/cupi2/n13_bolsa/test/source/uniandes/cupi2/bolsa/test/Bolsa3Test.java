...
import uniandes.cupi2.bolsa.mundo.bolsa3.*;

/**
 * Prueba de las operaciones de la bolsa de tipo 3
 * 
 */
public class Bolsa3Test extends AbstractBolsaTest
{
    /**
    ...
    {
        return new Bolsa3( inferior, superior );
    }
}
