...
public class PanelBolsa2 extends JPanel implements ActionListener
{
     ...
     */
    private static final String NOMBRE_FABRICA = "fabrica2";
     ...
     */
    public PanelBolsa2( Properties propiedades )
    {
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        else if( PanelOperaciones.AGREGAR.equals( e.getActionCommand( ) ) && bolsa2 != null )
        {
            agregar( );
        }
        // Accion cuando se hace click sobre eliminar
        else if( PanelOperaciones.ELIMINAR.equals( e.getActionCommand( ) ) && bolsa2 != null )
        {
            eliminar( );
        }
        // Accion cuando se hace click en buscar
        else if( PanelOperaciones.BUSCAR.equals( e.getActionCommand( ) ) && bolsa2 != null )
        {
            buscar( );
        }
        // Accion que se ejecuta cuando se hace click en eliminar
        else if( PanelOperaciones.RETORNAR.equals( e.getActionCommand( ) ) && bolsa2 != null )
        {
            retornar( );
        }
        ...
        else
        {
            ...
            try
            {
                getPanelInfoBolsa( ).actualizar( bolsa2 );
                getPanelRepresentacion( ).actualizar( bolsa2 );
                this.updateUI( );
            }
    ...
    private void iniciarBolsa( )
    {
        ...
        try
        {
            ...
            else
            {
                ...
                bolsa2 = fabrica.crearBolsa( numInferior, numSuperior );
            }
        }
    ...
    private void retornar( )
    {
        ...
        try
        {
            ...
            {
                int retorno = bolsa2.retornar( numRetornar );
