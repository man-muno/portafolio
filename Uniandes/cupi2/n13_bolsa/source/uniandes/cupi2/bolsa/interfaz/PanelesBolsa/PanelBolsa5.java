...
/**
 * Clase que representa el panel 1
 * @author Manuel Muñoz
 */
public class PanelBolsa5 extends JPanel implements ActionListener
{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    private static final String NOMBRE_FABRICA = "fabrica5";
     ...
     */
    public PanelBolsa5( Properties propiedades )
    {
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        else if( PanelOperaciones.AGREGAR.equals( e.getActionCommand( ) ) && bolsa5 != null )
        {
            agregar( );
        }
        // Accion cuando se hace click sobre eliminar
        else if( PanelOperaciones.ELIMINAR.equals( e.getActionCommand( ) ) && bolsa5 != null )
        {
            eliminar( );
        }
        // Accion cuando se hace click en buscar
        else if( PanelOperaciones.BUSCAR.equals( e.getActionCommand( ) ) && bolsa5 != null )
        {
            buscar( );
        }
        // Accion que se ejecuta cuando se hace click en eliminar
        else if( PanelOperaciones.RETORNAR.equals( e.getActionCommand( ) ) && bolsa5 != null )
        {
            retornar( );
        }
        ...
        else
        {
            ...
            try
            {
                getPanelInfoBolsa( ).actualizar( bolsa5 );
                getPanelRepresentacion( ).actualizar( bolsa5 );
                this.updateUI( );
            }
    ...
    private void iniciarBolsa( )
    {
        ...
        try
        {
            ...
            else
            {
                ...
                bolsa5 = fabrica.crearBolsa( numInferior, numSuperior );
            }
        }
    ...
    private void retornar( )
    {
        ...
        try
        {
            ...
            {
                int retorno = bolsa5.retornar( numRetornar );
