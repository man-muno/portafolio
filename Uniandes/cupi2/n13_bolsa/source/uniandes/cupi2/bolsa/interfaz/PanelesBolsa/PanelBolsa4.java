...
public class PanelBolsa4 extends JPanel implements ActionListener
{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    private static final String NOMBRE_FABRICA = "fabrica4";
     ...
     */
    public PanelBolsa4( Properties propiedades )
    {
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        else if( PanelOperaciones.AGREGAR.equals( e.getActionCommand( ) ) && bolsa4 != null )
        {
            agregar( );
        }
        // Accion cuando se hace click sobre eliminar
        else if( PanelOperaciones.ELIMINAR.equals( e.getActionCommand( ) ) && bolsa4 != null )
        {
            eliminar( );
        }
        // Accion cuando se hace click en buscar
        else if( PanelOperaciones.BUSCAR.equals( e.getActionCommand( ) ) && bolsa4 != null )
        {
            buscar( );
        }
        // Accion que se ejecuta cuando se hace click en eliminar
        else if( PanelOperaciones.RETORNAR.equals( e.getActionCommand( ) ) && bolsa4 != null )
        {
            retornar( );
        }
        ...
        else
        {
            ...
            try
            {
                getPanelInfoBolsa( ).actualizar( bolsa4 );
                getPanelRepresentacion( ).actualizar( bolsa4 );
                this.updateUI( );
            }
    ...
    private void iniciarBolsa( )
    {
        ...
        try
        {
            ...
            else
            {
                ...
                bolsa4 = fabrica.crearBolsa( numInferior, numSuperior );
            }
        }
    ...
    private void retornar( )
    {
        ...
        try
        {
            ...
            {
                int retorno = bolsa4.retornar( numRetornar );
