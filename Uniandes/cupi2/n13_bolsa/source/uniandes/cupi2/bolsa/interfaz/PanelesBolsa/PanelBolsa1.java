 ...
 */
public class PanelBolsa1 extends JPanel implements ActionListener
{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
     ...
     */
    public PanelBolsa1( Properties propiedades )
    {
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        else if( PanelOperaciones.AGREGAR.equals( e.getActionCommand( ) ) && bolsa1 != null )
        {
            agregar( );
        }
        // Accion cuando se hace click sobre eliminar
        else if( PanelOperaciones.ELIMINAR.equals( e.getActionCommand( ) ) && bolsa1 != null )
        {
            eliminar( );
        }
        // Accion cuando se hace click en buscar
        else if( PanelOperaciones.BUSCAR.equals( e.getActionCommand( ) ) && bolsa1 != null )
        {
            buscar( );
        }
        // Accion que se ejecuta cuando se hace click en eliminar
        else if( PanelOperaciones.RETORNAR.equals( e.getActionCommand( ) ) && bolsa1 != null )
        {
            retornar( );
        }
        ...
        else
        {
            ...
            try
            {
                getPanelInfoBolsa( ).actualizar( bolsa1 );
                getPanelRepresentacion( ).actualizar( bolsa1 );
                this.updateUI( );
            }
    ...
    private void iniciarBolsa( )
    {
        ...
        try
        {
            ...
            else
            {
                ...
                bolsa1 = fabrica.crearBolsa( numInferior, numSuperior );
            }
        }
    ...
    private void retornar( )
    {
        ...
        try
        {
            ...
            {
                int retorno = bolsa1.retornar( numRetornar );
