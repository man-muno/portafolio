...
public class TablaHashing<L, V>
{
     ...
     * <b>post: </b> Se contruyó una tabla vacía con 11 entradas y factor de carga 0.75.
     */
     ...
     * <b>post: </b> Se agregó el elemento asociado con la llave a la tabla.
     * @param llave La llave asociada con el elemento
     * @param elemento El elemento a ser agredo
     * @return El antiguo elemento asociado con la llave o null si no tenia ningún elemento asociado
     */
    @SuppressWarnings("unchecked")
     ...
     * <b>post: </b> Se retornó el elemento asociado con la llave especificada o null si éste no existe.
     * @param llave La llave del elemento que se desea recuperar
     * @return El elemento asociado con la llave o null si no existe tal asociación
     */
    @SuppressWarnings("unchecked")
     ...
     * <b>post: </b> Se eliminó de la tabla el elemento asociado con la llave especificada.
     * @param llave Llave del elemento que se desea eliminar
     * @return El elemento eliminado o null si la llave no tiene ningún elemento asociado en la tabla
     */
    @SuppressWarnings("unchecked")
     ...
     * <b>post: </b> Se realizó el reshash de la tabla.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Retorna el número de elementos que hay en la tabla. <br>
     * <b>post: </b> Se retornó el número de elementos que hay en la tabla.
