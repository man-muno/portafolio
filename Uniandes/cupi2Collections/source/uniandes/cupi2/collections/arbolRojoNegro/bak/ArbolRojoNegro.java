 ...
 */
public class ArbolRojoNegro<T extends Comparable> implements Serializable
{
    // -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
    ...
    public static void main( String[] args )
    {
        ...
        try
        {
            ...
            /*
             * System.out.println("\nPRUEBA 11"); arbol.eliminar(new Integer(2000));
             * 
             * raiz= arbol.darRaiz(); arbol.imprimirNodo(raiz); arbol.imprimirNodo(raiz.darHijoDerecho()); arbol.imprimirNodo(raiz.darHijoIzquierdo());
             * arbol.imprimirNodo(raiz.darHijoIzquierdo().darHijoIzquierdo()); arbol.imprimirNodo(raiz.darHijoIzquierdo().darHijoDerecho());
             * arbol.imprimirNodo(raiz.darHijoIzquierdo().darHijoIzquierdo().darHijoIzquierdo()); arbol.imprimirNodo(raiz.darHijoDerecho().darHijoIzquierdo());
             * arbol.imprimirNodo(raiz.darHijoDerecho().darHijoDerecho()); //arbol.imprimirNodo(raiz.darHijoDerecho().darHijoIzquierdo().darHijoDerecho());
             * arbol.imprimirNodo(raiz.darHijoDerecho().darHijoIzquierdo().darHijoIzquierdo());
             */
        ...
        /*
         * catch( NoExisteException e ) { e.printStackTrace(); }
         */
    }
