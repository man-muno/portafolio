/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: NodoRojoNegro.java,v 1.8 2006/06/20 20:34:50 da-romer Exp $
...
public class NodoRojoNegro<T extends Comparable<? super T>>
{
    ...
    /**
     * Agrega el elemento al árbol cuya raíz es el nodo actual. Primero se realiza la inserción, luego el
     * cambio de color y finalmente el balanceo.  <br>
    ...
    private void auxInsertar( T pElemento, Retorno retorno ) throws ExisteException
    {
        ...
        else if( resultado > 0 )
        {
            ...
            else
            {
                ...
                else //La rotación se debe realizar en este nivel
                {
                	//retorno.rotar= true;
                }
    ...
    {    	
    	...
    	else if((izqNodo.darHijoIzquierdo()!=null || izqNodo.darHijoDerecho()!=null) && derNodo!=null && izqNodo.darColor()==ROJO && derNodo.darColor()== ROJO && balance== BAL && retorno.diferenciaAltura) //Caso 3: Inserción en un 4 nodo que implica su división
    	{
    		izqNodo.cambiarColor(NEGRO);
    		derNodo.cambiarColor(NEGRO);
            retorno.cambioColor= false;
    	}
    	else if(color== NEGRO && izqNodo.darColor()== NEGRO && izqNodo.darHijoIzquierdo()!=null  && izqNodo.darHijoDerecho()!=null
    			 && retorno.diferenciaAltura) //Caso 4: Inserción en un 4 nodo que tiene padre negro y hubo aumento de altura
    	{    		
    		cambiarColor(ROJO);
    	...
    	else if(padreNodo!=null && padreNodo.darColor()== NEGRO && color== ROJO && izqNodo!=null && izqNodo.darColor()== NEGRO && izqNodo.darHijoDerecho()!=null 
    			&& izqNodo.darHijoIzquierdo()!=null && (izqNodo.darHijoIzquierdo().darHijoDerecho()!=null || izqNodo.darHijoIzquierdo().darHijoIzquierdo()!=null || izqNodo.darHijoDerecho().darHijoDerecho()!=null 
    			|| izqNodo.darHijoDerecho().darHijoIzquierdo()!=null ) && padreNodo.darHijoIzquierdo()== this) //Caso 5: Inserción en un 4 nodo que tiene padre rojo. La inserción se realizó sobre una rama externa
    	{
    	...
    	else if(padreNodo!=null && padreNodo.darColor()== NEGRO && color== ROJO && derNodo!=null && derNodo.darColor()== NEGRO && derNodo.darHijoDerecho()!=null 
    			&& derNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo()== this) //Caso 6: Inserción en un 4 nodo que tiene padre rojo. La inserción se realizó sobre una rama interna. El nodo debe ser un hijo izquierdo
    	{
    		padreNodo.cambiarColor(ROJO);     		    		
            ...
            retorno.cambioColor= false;
    			...
    			&& izqNodo.darHijoIzquierdo()!=null && padreNodo.darHijoDerecho()== this) //Caso 7: Inserción en un 4 nodo que tiene padre rojo. La inserción se realizó en una rama interna. El nodo debe ser un hijo derecho
    	{
    		padreNodo.cambiarColor(ROJO);     		    		
    		izqNodo.darHijoDerecho().cambiarColor(NEGRO);
    		izqNodo.darHijoIzquierdo().cambiarColor(NEGRO);    
    ...
    {   
    	...
    	else if((derNodo.darHijoDerecho()!=null || derNodo.darHijoIzquierdo()!=null) && izqNodo!=null && izqNodo.darColor()==ROJO 
                && derNodo.darColor()== ROJO && balance== BAL && retorno.diferenciaAltura) //Caso 3: Inserción en un 4 nodo que no implica balanceo
    	{
    		izqNodo.cambiarColor(NEGRO);
    		derNodo.cambiarColor(NEGRO);
            retorno.cambioColor= false;
    	}
    	else if(color== NEGRO && derNodo.darColor()== NEGRO && derNodo.darHijoDerecho()!=null  && izqNodo.darHijoIzquierdo()!=null
    			 && retorno.diferenciaAltura) //Caso 4: Inserción en un 4 nodo que tiene padre negro y hubo aumento de altura
    	{    		
    		cambiarColor(ROJO);
            ...
            retorno.cambioColor= false;
    			...
    			&& derNodo.darHijoIzquierdo()!=null && (derNodo.darHijoIzquierdo().darHijoDerecho()!=null || derNodo.darHijoIzquierdo().darHijoIzquierdo()!=null || derNodo.darHijoDerecho().darHijoDerecho()!=null 
    			|| derNodo.darHijoDerecho().darHijoIzquierdo()!=null ) && padreNodo.darHijoDerecho()== this ) //Caso 5: Inserción en un 4 nodo que tiene padre rojo rama externa
    	{
            ...
            retorno.cambioColor= false;
    			...
    			&& izqNodo.darHijoIzquierdo()!=null && padreNodo.darHijoDerecho()== this) //Caso 6: Inserción en un 4 nodo que tiene padre rojo rama interna
    	{
    		padreNodo.cambiarColor(ROJO);     		    		
    		izqNodo.darHijoDerecho().cambiarColor(NEGRO);
    		izqNodo.darHijoIzquierdo().cambiarColor(NEGRO);    
            ...
            retorno.cambioColor= false;
    			...
    			&& derNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo()== this) //Caso 7: Inserción en un 4 nodo que tiene padre rojo rama interna
    	{
    		padreNodo.cambiarColor(ROJO);     		    		
    		derNodo.darHijoDerecho().cambiarColor(NEGRO);
    		derNodo.darHijoIzquierdo().cambiarColor(NEGRO);
    ...
    private void cambiarColorNodosInsercionDer(Retorno retorno)
    {
    	...
    	if(derNodo!=null && izqNodo!=null && izqNodo.darColor()== ROJO && derNodo.darColor()== ROJO && balance== BAL && retorno.diferenciaAltura) //Si el nodo izquierdo y derecho son rojos se colorean negros.
    	{
    		izqNodo.cambiarColor(NEGRO);
    		derNodo.cambiarColor(NEGRO);
    	...
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama externa y el tío del nodo actual debe ser negro
    			...
    			&& derNodo.darHijoIzquierdo()!=null && (derNodo.darHijoIzquierdo().darHijoDerecho()!=null || derNodo.darHijoIzquierdo().darHijoIzquierdo()!=null || derNodo.darHijoDerecho().darHijoDerecho()!=null 
    			|| derNodo.darHijoDerecho().darHijoIzquierdo()!=null ) && padreNodo.darHijoDerecho()== this && padreNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo().darColor()==NEGRO) //Caso 5: Inserción en un 4 nodo que tiene padre rojo rama externa
    	{
    	...
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama externa y el tío del nodo actual debe ser rojo
                ...
                && derNodo.darHijoIzquierdo()!=null && (derNodo.darHijoIzquierdo().darHijoDerecho()!=null || derNodo.darHijoIzquierdo().darHijoIzquierdo()!=null || derNodo.darHijoDerecho().darHijoDerecho()!=null 
                || derNodo.darHijoDerecho().darHijoIzquierdo()!=null ) && padreNodo.darHijoDerecho()== this && padreNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo().darColor()==ROJO) //Caso 5: Inserción en un 4 nodo que tiene padre rojo rama externa
        {
    	...
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama interna. El nodo debe ser un hijo derecho y el tio debe ser negro
    			...
    			&& izqNodo.darHijoIzquierdo()!=null && padreNodo.darHijoDerecho()== this && padreNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo().darColor()==NEGRO) //Caso 6: Inserción en un 4 nodo que tiene padre rojo rama interna
    	{
    		padreNodo.cambiarColor(ROJO);
    		retorno.rotar= false;
    	}
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama interna. El nodo debe ser un hijo izquierdo y el tio debe ser negro
    	else if(padreNodo!=null && padreNodo.darColor()== NEGRO && color== ROJO && derNodo!=null && derNodo.darColor()== NEGRO && derNodo.darHijoDerecho()!=null 
    			&& derNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo()== this && padreNodo.darHijoDerecho()!=null && padreNodo.darHijoDerecho().darColor()==NEGRO) //Caso 7: Inserción en un 4 nodo que tiene padre rojo rama interna
    	{
    		padreNodo.cambiarColor(ROJO);
    		retorno.rotar= false;
    	}
    	else if(((color== NEGRO && padreNodo!=null) || (padreNodo== null && color== ROJO)) && derNodo.darColor()== NEGRO && derNodo.darHijoDerecho()!=null  && izqNodo.darHijoIzquierdo()!=null && retorno.diferenciaAltura) //Caso 4: Inserción en un 4 nodo que tiene padre negro y hubo aumento de altura
	   	{    		
	   		derNodo.cambiarColor(ROJO);
    ...
    private void cambiarColorNodosInsercionIzq(Retorno retorno)
    {
        ...
        //Si el nodo izquierdo y derecho son rojos se colorean negros.
    	if(derNodo!=null && izqNodo!=null && izqNodo.darColor()== ROJO && derNodo.darColor()== ROJO
           && balance== BAL && retorno.diferenciaAltura) 
    	{
    		izqNodo.cambiarColor(NEGRO);
    		derNodo.cambiarColor(NEGRO);
    	...
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama externa y el tío del nodo actual debe ser negro
    			...
    			&& izqNodo.darHijoIzquierdo()!=null && (izqNodo.darHijoIzquierdo().darHijoDerecho()!=null || izqNodo.darHijoIzquierdo().darHijoIzquierdo()!=null || izqNodo.darHijoDerecho().darHijoDerecho()!=null 
    			|| izqNodo.darHijoDerecho().darHijoIzquierdo()!=null ) && padreNodo.darHijoIzquierdo()== this && padreNodo.darHijoDerecho()!=null && padreNodo.darHijoDerecho().darColor()==NEGRO )
    	{
    	...
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama externa y el tío del nodo actual debe ser rojo
                ...
                && izqNodo.darHijoIzquierdo()!=null && (izqNodo.darHijoIzquierdo().darHijoDerecho()!=null || izqNodo.darHijoIzquierdo().darHijoIzquierdo()!=null || izqNodo.darHijoDerecho().darHijoDerecho()!=null 
                || izqNodo.darHijoDerecho().darHijoIzquierdo()!=null ) && padreNodo.darHijoIzquierdo()== this && padreNodo.darHijoDerecho()!=null && padreNodo.darHijoDerecho().darColor()==ROJO )
        {
    	...
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama interna. El nodo debe ser un hijo izquierdo y el tio debe ser negro
    			...
    			&& derNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo()== this && padreNodo.darHijoIzquierdo()== this && padreNodo.darHijoDerecho()!=null && padreNodo.darHijoDerecho().darColor()==NEGRO) 
    	{
    		padreNodo.cambiarColor(ROJO);
    		retorno.rotar= false;
    	}
    	//La inserción se realizó en un 4 nodo que tiene padre Negro. La inserción se realizó sobre una rama interna. El nodo debe ser un hijo derecho y el tio debe ser negro
    			...
    			&& izqNodo.darHijoIzquierdo()!=null && padreNodo.darHijoDerecho()== this && padreNodo.darHijoDerecho()== this && padreNodo.darHijoIzquierdo()!=null && padreNodo.darHijoIzquierdo().darColor()==NEGRO) 
    	{
    		padreNodo.cambiarColor(ROJO);
    		retorno.rotar= false;
    	}
    	//
    	else if(((color== NEGRO && padreNodo!=null) || (padreNodo== null && color== ROJO)) && izqNodo.darColor()== NEGRO && izqNodo.darHijoDerecho()!=null  && derNodo!= null && derNodo.darHijoIzquierdo()!=null && retorno.diferenciaAltura) 
	   	{    		
	   		izqNodo.cambiarColor(ROJO);
    ...
    public Arbol2_4<T> darArbol2_4()
    {
        ...
        while( cola.darLongitud( ) != 0 )
        {
            ...
            catch( ColaVaciaException e )
            {
                ...
                catch( uniandes.cupi2.collections.arbol2_4.ExisteException e )
                {                    
                    //Nunca debería aparecer esta excepción                    
                }
