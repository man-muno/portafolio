/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: Nodo2_4.java,v 1.1 2008/03/30 01:53:03 jua-gome Exp $
 ...
 */
public class Nodo2_4<T extends Comparable> implements Serializable
{
    // -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
    ...
    /**
     * Devuelve el Hijo 2 del nodo (centro izquierda). <br>
     * <b>post: </b> Se retornó el hijo 2 del nodo. <br>
     * @return Hijo 2 del nodo (centro izquierda)
     */
    ...
    /**
     * Devuelve el Hijo 3 del nodo (centro derecha). <br>
     * <b>post: </b> Se retornó el hijo 3 del nodo. <br>
     * @return Hijo 3 del nodo (centro derecha)
     */
    ...
    /**
     * Devuelve el Hijo 4 del nodo (derecha). <br>
     * <b>post: </b> Se retornó el hijo 4 del nodo. <br>
     * @return Hijo 4 del nodo (derecha)
     */
     ...
     * @return Devuelve la altura del árbol. Entero mayor o igual a 1.
     */
    ...
    /**
     * Agrega un nuevo elemento al árbol 2-4 cuya raíz es este nodo y retorna el nodo que corresponde a la nueva raíz del árbol<br>
     ...
     */
    public Nodo2_4<T> insertar( T obj ) throws ElementoExisteException
    {
     ...
     */
    public Nodo2_4<T> eliminar( T obj ) throws ElementoNoExisteException
    {
    ...
    private boolean restaurar1( )
    {
        ...
        /*
         * else if(r2!=null) { h2.r1 = r2; r2 = h3.r1; h2.h2 = h3.h1; h3.h1 = h3.h2; h3.h2 = null; if(h3.r2!=null) {
         * 
         * h3.r1 = h3.r2; h3.r2 = h3.r3; h3.h2 = h3.h3; h3.h3 = h3.h4; h3.h4 = null; return false; } else if(r3!=null) { h3.r1 = r3; r3 = h4.r1; h3.h2 = h4.h1; h4.h1 = h4.h2;
         * h4.h2 = null; if(h4.r2!=null) {
         * 
         * h4.r1 = h4.r2; h4.r2 = h4.r3; h4.h2 = h4.h3; h4.h3 = h4.h4; h4.h4 = null; return false; } else return restaurar4(); } else return restaurar3(); }
         */
        else
            return restaurar2( );
    }
