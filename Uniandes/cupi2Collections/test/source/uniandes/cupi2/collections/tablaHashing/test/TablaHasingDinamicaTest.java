 ...
 * $Id: TablaHasingDinamicaTest.java,v 1.1 2008/03/28 03:38:05 jua-gome Exp $
 ...
 */
public class TablaHasingDinamicaTest extends AbstractTablaHashingTest
{
    ...
    {
        return new TablaHashingDinamica<String, Integer>();
    }
