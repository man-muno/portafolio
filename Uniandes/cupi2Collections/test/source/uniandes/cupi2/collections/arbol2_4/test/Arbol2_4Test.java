package uniandes.cupi2.collections.arbol2_4.test;


import junit.framework.TestCase;
import uniandes.cupi2.collections.arbol2_4.Arbol2_4;
import uniandes.cupi2.collections.arbol2_4.ExisteException;
import uniandes.cupi2.collections.arbol2_4.NoExisteException;
import uniandes.cupi2.collections.arbol2_4.Nodo2_4;
import uniandes.cupi2.collections.arbolRojoNegro.ArbolRojoNegro;
import uniandes.cupi2.collections.arbolRojoNegro.NodoRojoNegro;
import uniandes.cupi2.collections.iterador.Iterador;

/**
 * Esta es la clase usada para verificar los métodos de la clase árbol 2_3
 */
public class Arbol2_4Test extends TestCase
{
    // -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
    ...
    public void testInsertar1( )
    {
        ...
        try
        {
            ...
            assertEquals( "El elemento debería ser 5", elementos[ 5 ], raiz.darRaiz1( ) ); // Verificar el contenido de los nodos
            ...
            assertEquals( "El elemento debería ser 4", elementos[ 4 ], raiz.darRaiz1( ) ); // Verificar el contenido de los nodos
            assertEquals( "El elemento debería ser 5", elementos[ 5 ], raiz.darRaiz2( ) );
            assertEquals( "El elemento debería ser 6", elementos[ 6 ], raiz.darRaiz3( ) );
            verificarInvariante( );
            ...
            assertEquals( "El elemento debería ser 5", elementos[ 5 ], raiz.darRaiz1( ) ); // Verificar el contenido de los nodos
            assertNull( "El elemento debería ser null", raiz.darRaiz2( ) ); // Verificar el contenido de los nodos
            assertNull( "El elemento debería ser null", raiz.darRaiz3( ) ); // Verificar el contenido de los nodos            
            assertEquals( "El elemento debería ser 3", elementos[ 3 ], hijo1.darRaiz1( ) );
            assertEquals( "El elemento debería ser 4", elementos[ 4 ], hijo1.darRaiz2( ) );
            assertNull( "El elemento debería ser null", hijo1.darRaiz3( ) );
            assertEquals( "El elemento debería ser 6", elementos[ 6 ], hijo2.darRaiz1( ) );
            assertNull( "El elemento debería ser null", hijo2.darRaiz2( ) );
            assertNull( "El elemento debería ser null", hijo2.darRaiz3( ) );            
            assertNull( "El hijo 3 debería ser null", hijo3 );
            assertNull( "El hijo 3 debería ser null", hijo4 );
            verificarInvariante( );
            ...
            assertNull( "El elemento debería ser null", hijo1.darRaiz3( ) );
            assertEquals( "El elemento debería ser 6", elementos[ 6 ], hijo2.darRaiz1( ) );
            assertEquals( "El elemento debería ser 7", elementos[ 7 ], hijo2.darRaiz2( ) );
            assertNull( "El elemento debería ser null", hijo2.darRaiz3( ) );            
            assertNull( "El hijo 3 debería ser null", hijo3 );
            assertNull( "El hijo 3 debería ser null", hijo4 );
            verificarInvariante( );
            ...
            assertNull( "El elemento debería ser null", raiz.darRaiz2( ) ); // Verificar el contenido de los nodos
            assertNull( "El elemento debería ser null", raiz.darRaiz3( ) ); // Verificar el contenido de los nodos
            assertEquals( "El elemento debería ser 2", elementos[ 2 ], hijo1.darRaiz1( ) );
            assertEquals( "El elemento debería ser 3", elementos[ 3 ], hijo1.darRaiz2( ) );
            assertEquals( "El elemento debería ser 4", elementos[ 4 ], hijo1.darRaiz3( ) );
            assertEquals( "El elemento debería ser 6", elementos[ 6 ], hijo2.darRaiz1( ) );
            assertEquals( "El elemento debería ser 7", elementos[ 7 ], hijo2.darRaiz2( ) );
            assertNull( "El elemento debería ser null", hijo2.darRaiz3( ) );            
            assertNull( "El hijo 3 debería ser null", hijo3 );
            ...
            assertEquals( "El elemento debería ser 7", elementos[ 7 ], hijo3.darRaiz2( ) );
            ...
            assertEquals( "El elemento debería ser 6", elementos[ 6 ], hijo3.darRaiz1( ) );
            assertEquals( "El elemento debería ser 7", elementos[ 7 ], hijo3.darRaiz2( ) );
            assertEquals( "El elemento debería ser 8", elementos[ 8 ], hijo3.darRaiz3( ) );                        
            assertNull( "El hijo 3 debería ser null", hijo4 );
            verificarInvariante( );
            ...
            Iterador<Integer> iterador = arbol.inorden( );

            int cont = 0;
            while( iterador.haySiguiente( ) )
            {
                Integer elemento = iterador.darSiguiente( );
