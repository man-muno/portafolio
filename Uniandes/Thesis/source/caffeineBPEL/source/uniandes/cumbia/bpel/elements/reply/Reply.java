...
/**
 * Represents a Reply bpel activity
 */
public class Reply extends AbstractReply
{
    ...
    /**
     * The portType (optional) for the reply
     */
    private String portType;
    
    /**
     * The operation that the partner expects to be invoked
     */
    private String operation;
 
    /**
     * The fault name of the reply
     */
    ...
    public Reply(ModelInstance modelInstance, String elementName, String typeName)
    {
