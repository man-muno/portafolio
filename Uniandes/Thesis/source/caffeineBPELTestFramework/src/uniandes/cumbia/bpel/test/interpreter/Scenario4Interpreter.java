...
public class Scenario4Interpreter extends AbstractInterpreter
{
    ...
    public StringBuffer test( )
    {
        ...
        try
        {
            ...
            //The next element to be executed is the receive
            buffer.append( "|Execution Order: 4->receive: " + isElementExecuted("receive", 4)  + "\n");            
            ...
            buffer.append("|receive.Init=>Waiting| == 1: " + (getNumberOfTimesTraced("receive", "exitInit") == 1) + "\n");
            ...
            buffer.append( "|input == \"second message\": " + isValue( "input", "second message" )+ "\n");
            //The output element receives the value            
            buffer.append( "|output == \"Hello second message\": " + isValue( "output", "Hello initial message" )+ "\n");
