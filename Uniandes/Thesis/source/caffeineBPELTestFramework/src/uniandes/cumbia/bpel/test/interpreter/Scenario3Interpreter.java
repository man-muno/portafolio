...
public class Scenario3Interpreter extends AbstractInterpreter
{
    ...
    public StringBuffer test( )
    {
        ...
        try
        {
            ...
            buffer.append( "|Execution Order: 5->onMessage: " + isElementExecuted("onMessage", 5)  + "\n");
            ...
            //The onMessage element is executed only once            
            buffer.append("|onMessage.Init=>Waiting| == 1: " + (getNumberOfTimesTraced("onMessage", "exitInit") == 1) + "\n");
            //The empty element is executed only once            
            buffer.append("|empty.Init=>Waiting| == 1: " + (getNumberOfTimesTraced("empty", "exitInit") == 1) + "\n");            
