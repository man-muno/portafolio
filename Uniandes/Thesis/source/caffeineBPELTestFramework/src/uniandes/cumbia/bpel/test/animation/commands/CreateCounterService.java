...
import uniandes.cumbia.bpel.test.instantiation.utils.CounterService;
...
public class CreateCounterService implements IAnimationCommand, Runnable
{
    ...
    public CreateCounterService( String processName, String serviceName )
    {
    ...
    public void execute( )
    {
        WSDLNames.getInstance().setId(MessageCenter.getInstance( ).createNewService( new CounterService(processName) ),serviceName);
    }
