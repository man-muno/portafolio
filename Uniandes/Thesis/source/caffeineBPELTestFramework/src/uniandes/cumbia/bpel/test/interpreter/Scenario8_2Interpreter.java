...
public class Scenario8_2Interpreter extends AbstractInterpreter
{
    ...
    public StringBuffer test( )
    {
        ...
        try
        {
            ...
            //The next element to be executed is the invoke
            buffer.append( "|Execution Order: 5->empty3: " + isElementExecuted("empty3", 5)  + "\n");
