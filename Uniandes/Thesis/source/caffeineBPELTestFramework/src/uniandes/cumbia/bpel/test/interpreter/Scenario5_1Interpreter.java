...
public class Scenario5_1Interpreter extends AbstractInterpreter
{
    ...
    public StringBuffer test( )
    {
        ...
        try
        {
            ...
            buffer.append( "|Execution Order: 4->invoke: " + isElementExecuted("invoke", 4)  + "\n");            
            ...
            buffer.append("|invoke.Init=>Waiting| == 1: " + (getNumberOfTimesTraced("invoke", "exitInit") == 1) + "\n");
            ...
            buffer.append( "|output == \"Hello Service Response\": " + isValue( "output", "Hello Service Response" )+ "\n");
