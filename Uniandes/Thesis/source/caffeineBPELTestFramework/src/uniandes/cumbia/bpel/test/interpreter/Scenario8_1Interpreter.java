...
public class Scenario8_1Interpreter extends AbstractInterpreter
{
    ...
    public StringBuffer test( )
    {
        ...
        try
        {
            ...
            buffer.append( "|Execution Order: 4->CondtionalIf: " + isElementExecuted("ConditionalIf", 4)  + "\n");
            //The next element to be executed is the invoke
            buffer.append( "|Execution Order: 5->empty2: " + isElementExecuted("empty2", 5)  + "\n");
            //The next element to be executed is the AssignElement6a54f9   
            buffer.append( "|Execution Order: 6->AssignElement6a54f9: " + isElementExecuted("AssignElement6a54f9", 6)  + "\n");
            //The next element to be executed is the replyOutput
            buffer.append( "|Execution Order: 7->replyOutput: " + isElementExecuted("replyOutput", 7)  + "\n");
            ...
            //The sequence element is executed only once
            buffer.append("|ConditionalIf.Init=>Waiting| == 1: " + (getNumberOfTimesTraced("ConditionalIf", "exitInit") == 1) + "\n");
            //The sequence element is executed only once
            ...
            buffer.append( "|input == \"elseIf\": " + isValue( "input", "elseIf" )+ "\n");
