package uniandes.cumbia.aspect.test.instantiation;
...
public class Instantiator implements IInstanciator
{
    ...
    public Instantiator()
    {
        ...
        File kernelPropertiesAspect = new File("./data/kernelAspect.properties");
        ...
        IAspectEngine aspectEngine = null;
        
        try
        {
            File conflictsFile = new File("./data/aspects/conflicts.xml");
            aspectEngine = new AspectEngine(kernelPropertiesAspect,conflictsFile,engine);
        }
        catch( LoaderException e )
        {
            e.printStackTrace();
        ...
        engine.setAspectEngine( aspectEngine );
