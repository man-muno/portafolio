...
public class RemoveAspect implements IAnimationCommand, Runnable
{
    ...
    public RemoveAspect( String name, String processName, String processId, String instanceId )
    {
        this.name = name;
    ...
    public void execute( )
    {
        EngineHolder.getInstance( ).getEngine( ).removeAspect(name,processName,Integer.parseInt( processId),Integer.parseInt( instanceId));
    }
