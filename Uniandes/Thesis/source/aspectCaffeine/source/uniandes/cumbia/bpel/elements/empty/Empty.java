...
/**
 * Represents a Empty bpel activity
 */
public class Empty extends AbstractEmpty
{
     ...
     */
    public Empty( ModelInstance modelInstance, String elementName, String typeName )
    {
