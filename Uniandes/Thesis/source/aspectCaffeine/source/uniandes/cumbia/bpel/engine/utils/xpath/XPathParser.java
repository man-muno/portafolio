...
// Note: XPath does not have reserved words, so we have to include all these terminals
  final public String NCName() throws ParseException {
    ...
    case FUNCTION_FORMAT_NUMBER:
      ...
      break;
    case FUNCTION_BPEL_GET_VARIABLE_DATA:
      jj_consume_token(FUNCTION_BPEL_GET_VARIABLE_DATA);
      break;
    default:
      jj_la1[0] = jj_gen;
      jj_consume_token(-1);
  ...
  final public int CoreFunctionName() throws ParseException {
    ...
    case FUNCTION_BPEL_GET_VARIABLE_DATA:
      jj_consume_token(FUNCTION_BPEL_GET_VARIABLE_DATA);
                                               code = Compiler.FUNCTION_BPEL_GET_VARIABLE_DATA;
      break;
    default:
      jj_la1[2] = jj_gen;
      jj_consume_token(-1);
...
/* [38]    NodeType    ::=    'comment' | 'text'  | 'processing-instruction'  | 'node'  */
  ...
  final private boolean jj_3R_57() {
    if (jj_scan_token(FUNCTION_BPEL_GET_VARIABLE_DATA)) return true;
    return false;
  }
