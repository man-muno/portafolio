/*******************************************************************************
 * $Id: Process.java,v 1.3 2009/02/11 18:11:58 man-muno Exp $
 * 
 * Proyecto Cumbia
...
public class Process extends OpenObject implements IProcess
{
    ...
    private static final String PROCESS_EXECUTE = "newExecute";
     ...
     * Generator of the event finalized
     */
    private EventGenerator generatorProcessNewToExecute;
    ...
    public void registerGeneratedEvents()
    {
        ...
        generatorProcessNewToExecute = createAndRegisterEventGenerator( PROCESS_EXECUTE );
    }
    ...
    {
        generatorProcessNewToExecute.generate( );
    }
