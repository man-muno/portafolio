...
public class ExecuteFirstCopy implements IAction
{
    ...
    /**
     * Executes the first copy of an assign
     * 
     * @param event 
    ...
    public void execute( EventNotification event, Transition transition, IOpenObject element )
    {
        ...
        ICopy copy = assign.getCopies( ).get( 0 );
        ITo to = copy.getTo( );
        ...
        switch( to.getType( ) )
        {
            ...
            case ITo.VARIABLE_VARIANT:
            {
                ...
                // //System.out.println(context.getContextBean( ));
                ...
                if( toQuery != null )
                {/*
                     * try { Object toElementAux = context.getValue( toQuery ); if( toElementAux != null ) toElement = toElementAux; } catch( JXPathException e ) {
                     * e.printStackTrace( ); throw new RuntimeException("Problems calculating the expression for the To element"); }
                     */
                }
            }
