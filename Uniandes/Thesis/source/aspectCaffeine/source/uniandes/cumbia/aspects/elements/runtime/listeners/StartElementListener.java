/*******************************************************************************
 * $Id: StartElementListener.java,v 1.1 2009/01/29 21:38:43 man-muno Exp $
 * 
 * Proyecto Cumbia
...
public class StartElementListener implements IEventListener 
{
	// -----------------------------------------------
    // Attributes
    // -----------------------------------------------
     ...
     */
    public StartElementListener( AspectRuntime rt )
    {
        runtime = rt;
    }
