 ...
 */
public class DefaultEventSourceLong extends EventSource {
    ...
    public DefaultEventSourceLong(final String signalName,
        ...
        super(new EventSourceClient(), 100, URI.create(baseURL + signalName
            ...
            public void onMessage(String event, MessageEvent message) {
                controller.newValue(signalName, Long.parseLong(message.data));
            }
        ...
        try {
            ...
            controller.newValue(signalName, new BigDecimal(response.toString()).longValue());
